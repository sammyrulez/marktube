...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tube_userprofile', 'user', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['auth.User'], unique=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.user'
        db.delete_column('tube_userprofile', 'user_id')
