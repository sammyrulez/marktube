...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TPAccount.tp_username'
        db.add_column('tube_tpaccount', 'tp_username', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TPAccount.tp_username'
        db.delete_column('tube_tpaccount', 'tp_username')
